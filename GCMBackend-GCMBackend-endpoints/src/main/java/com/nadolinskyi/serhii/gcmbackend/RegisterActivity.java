 ...
 * GCMIntentService2.java. If you're going to be running a local version of the
 * App Engine backend (using the DevAppServer), you'll need to toggle the
 * LOCAL_ANDROID_RUN flag in CloudEndpointUtils2.java. See the javadoc in these
...
/*    private static final String LOG_TAG = "RegisterActivityGCM";
