 ...
 * on 2013-07-04 at 08:13:48 UTC 
 * Modify at your own risk.
 */

package com.nadolinskyi.serhii.gcmbackend.messageEndpoint;
...
public class MessageEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListMessages extends MessageEndpointRequest<com.nadolinskyi.serhii.gcmbackend.messageEndpoint.model.CollectionResponseMessageData> {
    ...
    protected ListMessages() {
      super(MessageEndpoint.this, "GET", REST_PATH, null, com.nadolinskyi.serhii.gcmbackend.messageEndpoint.model.CollectionResponseMessageData.class);
    }
  ...
  public class SendMessage extends MessageEndpointRequest<Void> {
    ...
    protected SendMessage(java.lang.String nickname, java.lang.String message) {
      ...
      this.nickname = com.google.api.client.util.Preconditions.checkNotNull(nickname, "anon");
    }
